...
const docsUrl = 'https://help.onehash.ai/en/';

frappe.help.help_links['Form/Rename Tool'] = [
	{ label: 'Bulk Rename', url: docsUrl + 'article/bulk-rename-45ekqg/' },
]

//Setup

frappe.help.help_links['List/User'] = [
	{ label: 'New User', url: docsUrl + 'article/how-to-add-users-wsgb7e/' }	
]

frappe.help.help_links['permission-manager'] = [
	{ label: 'Role Permissions Manager', url: docsUrl + 'article/how-to-set-role-based-permissions-1om5gy' },
...
frappe.help.help_links['modules/Accounts'] = [
	{ label: 'Introduction to Accounts', url: docsUrl + 'category/accounting-93tnty/' },
	{ label: 'Chart of Accounts', url: docsUrl + 'article/chart-of-accounts-1fpqxjr' },
	{ label: 'Multi Currency Accounting', url: docsUrl + 'article/how-to-set-up-multi-currency-accounting-zn80ow/' },
]

frappe.help.help_links['Tree/Account'] = [
	{ label: 'Chart of Accounts', url: docsUrl + 'article/chart-of-accounts-1fpqxjr' },
	//{ label: 'Managing Tree Masters', url: docsUrl + 'user/manual/en/setting-up/articles/managing-tree-structure-masters' },
]

frappe.help.help_links['Form/Sales Invoice'] = [
	{ label: 'Sales Invoice', url: docsUrl + 'article/everything-you-should-know-about-creating-a-sales-invoice-j7mv0e' },
	//{ label: 'Accounts Opening Balance', url: docsUrl + 'user/manual/en/accounts/opening-accounts' },
	{ label: 'Sales Return', url: docsUrl + 'article/creating-a-sales-return-dif5q5/' },
...
frappe.help.help_links['pos'] = [
	{ label: 'Point of Sale Invoice', url: docsUrl + 'article/creating-a-pos-point-of-sale-invoice-1m6utgs/' },
]

frappe.help.help_links['List/POS Profile'] = [
	{ label: 'Point of Sale Profile', url: docsUrl + 'article/creating-a-pos-point-of-sale-invoice-1m6utgs/' },
]

frappe.help.help_links['List/Purchase Invoice'] = [
	{ label: 'Purchase Invoice', url: docsUrl + 'article/purchase-invoice-9tv197/' },
	//{ label: 'Accounts Opening Balance', url: docsUrl + 'user/manual/en/accounts/opening-accounts' },
	{ label: 'Recurring Purchase Invoice', url: docsUrl + 'article/how-to-set-up-auto-repeat-1ur9ccp' },
]

frappe.help.help_links['List/Journal Entry'] = [
	{ label: 'Journal Entry', url: docsUrl + 'article/how-to-create-a-journal-entry-2ooqoy/' },
	{ label: 'Advance Payment Entry', url: docsUrl + 'article/how-to-create-an-advance-payment-entry-r4ty9i/' },
	//{ label: 'Accounts Opening Balance', url: docsUrl + 'user/manual/en/accounts/opening-accounts' },
]

frappe.help.help_links['List/Payment Entry'] = [
	{ label: 'Payment Entry', url: docsUrl + 'article/what-is-that-you-need-to-know-about-payment-entries-6jvx61/' },
]

frappe.help.help_links['List/Payment Request'] = [
	{ label: 'Payment Request', url: docsUrl + 'article/creating-a-payment-request-nnjyws' },
]

frappe.help.help_links['List/Asset'] = [
	{ label: 'Managing Fixed Assets', url: docsUrl + 'article/asset-management-59jhve' },
]
