...
frappe.ui.form.on('Shopify Log', {
	...
	frm.dashboard.add_comment(__("Shopify Integration will be removed from OneHash in Version 14. Please install {0} app to continue using it.", [app_link]), "yellow", true);
	}
});
