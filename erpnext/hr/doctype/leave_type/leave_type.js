...
frappe.tour["Leave Type"] = [
	...
	},
	{
		...
		description: __("Leaves you can avail against a holiday you worked on. You can claim Compensatory Off Leave using Compensatory Leave request. Click") + " <a href='https://help.onehash.ai/en/article/compensatory-leave-request-dlf7p2/' target='_blank'>here</a> " + __('to know more')
	},
	{
